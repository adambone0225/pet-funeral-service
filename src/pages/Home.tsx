  ...
  return (
    <>
      ...
      100% { opacity: 0; }}
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-6 lg:px-8 w-full mt-6 sm:mt-8 pb-10 sm:pb-12 lg:pb-0">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <motion.div
              ...
              className="order-2 lg:order-1 lg:col-span-6 relative mt-2 sm:mt-4 lg:mt-0 pr-2 sm:pr-0"
            >
              <div className="absolute inset-0 bg-[#D98C5A] rounded-[2.5rem] translate-x-2 translate-y-4 sm:translate-x-6 sm:translate-y-6" />
              <div className="relative bg-[#F3D0B4] p-12 sm:p-14 rounded-[2.5rem] z-10">
            ...
            <motion.div
              ...
              className="order-1 lg:order-2 lg:col-span-6 relative flex justify-center items-center h-[260px] sm:h-[460px] lg:h-[700px] -mb-10 sm:mb-0 mt-0"
              // Changed mobile: h-[340px] -> h-[260px] and added -mb-10
              // Added sm:mb-0 to ensure desktop spacing remains unchanged
            >
              {/* Refined Cloud Plinth */}
              <div className="absolute bottom-10 sm:bottom-20 w-[240px] sm:w-[300px] h-16 sm:h-20 bg-white/40 blur-2xl rounded-[100%] mix-blend-overlay" />

              <div className="relative z-10 flex flex-col items-center">
                <img
                  src="/img/cat.png"
                  alt="Peaceful Angel Cat"
                  className="w-[100%] sm:w-[640px] lg:w-[900px] max-w-none h-auto object-contain relative z-5"
                  style={{
                    maskImage:
